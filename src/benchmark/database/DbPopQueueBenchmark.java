...
public class DbPopQueueBenchmark extends BenchmarkTest {
    private static Logger logger = Logger.getLogger(DbPopQueueBenchmark.class);
    private final int queue;
    private final int receiver;
    private CallableStatement statement = null;

    public DbPopQueueBenchmark(Connection connection, int duration, Scanner sc) {
